module.exports = (function() {
	...
	returnCompleteBalances: function(callback) {
        ...
        buy: function(currencyA, currencyB, rate, amount, fillOrKill, immediateOrCancel, postOnly, callback) {
            var parameters = {
		currencyPair: joinCurrencies(currencyA, currencyB),
		rate: rate,
		amount: amount,
        ...
        sell: function(currencyA, currencyB, rate, amount, fillOrKill, immediateOrCancel, postOnly, callback) {
            var parameters = {
		currencyPair: joinCurrencies(currencyA, currencyB),
		rate: rate,
		amount: amount,
